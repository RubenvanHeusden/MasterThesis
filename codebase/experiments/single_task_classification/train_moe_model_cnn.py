...
def main(dataset_class, device, batch_size, random_seed, lr, scheduler_step_size, scheduler_gamma,
         use_lengths, do_lowercase, embedding_dim, output_dim, num_filters_g, num_filters_experts,
         filter_list_g, filter_list_experts,
    ...
    g = ConvNet(input_channels=1, output_dim=n_experts, filter_list=filter_list_g,
                    embed_matrix=TEXT.vocab.vectors, num_filters=num_filters_g)
    expert_networks = [ConvNet(input_channels=1, output_dim=output_dim, filter_list=filter_list_experts,
                    embed_matrix=TEXT.vocab.vectors, num_filters=num_filters_experts)
...
if __name__ == "__main__":
    ...
    main(dataset, args.device, args.batch_size, args.random_seed, args.learning_rate,
         ...
         args.use_lengths, args.do_lowercase, args.embedding_dim, output_dim, args.num_filters_g,
         args.num_filters_experts, filter_list_g, filter_list_g, args.n_experts,
